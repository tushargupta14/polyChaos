function idx = myStrmatchi(str,strcellarray,exact)
% myStrmatchi Does the same than Matlab's STRMATCH function; however,
% Mathwork plans to remove (for unknown reasons) STRMATCH in future
% releases. In comparison to myStrmatch, this function performs a
