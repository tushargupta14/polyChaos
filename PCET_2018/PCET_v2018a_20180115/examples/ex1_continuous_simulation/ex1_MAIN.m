...
results3 = PCETsimGalerkin(sys,'ex1_ODE','ex1_OUT',simoptions,'uv',2);
...
colloc3 = PCETsimCollocation(sys,'ex1_MCODE','ex1_MCOUT',col_samples,simoptions,'uv',2);
