function results = PCETsimGalerkin(PCETsys, RHSfile, OUTfile, simoptions, varargin)
% PCETsim = PCETsimGalerkin(PCETsys, RHSfile, OUTfile) 
...
%
% PCETsim = PCETsimGalerkin(..., 'in1', data1, ..., 'inN', dataN) 
% simulates the system with inputs 'in1' to 'inN'. The inputs' names and
% data have to match those specified in PCETsys.inputs (see examples for
