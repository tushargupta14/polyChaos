function dXdt = ex4_ODE_M(t,X,PCETsystem,u1_t,u1_v)
 ...
 ddt_x_1 = M.p_1_O2*x_1x_2 - M.p_1_O1*x_1 + M.p_2_O1*x_2 + u1*M.one_O1*x_2;
 ddt_x_2 = - M.p_1_O2*x_1x_2 + M.p_1_O1*x_1 - M.p_2_O1*x_2 - M.p_3_O1*x_2 - u1*M.one_O1*x_2;
