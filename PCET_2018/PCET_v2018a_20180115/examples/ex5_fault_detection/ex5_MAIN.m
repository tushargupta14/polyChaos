...
fprintf('NOTE: Upcoming warnings about unused variables can be ignored - still needs to be fixed!\n');
...
sys_org = PCETcompose(states,param_org,inputs,outputs,pce_order);
...
sys_fauA = PCETcompose(states,param_fauA,inputs,outputs,pce_order);
...
sys_fauB = PCETcompose(states,param_fauB,inputs,outputs,pce_order);
...
basis_evals_org  = PCETsample(sys_org, 'basis',n_samples);
basis_evals_fauA = PCETsample(sys_fauA,'basis',n_samples);
basis_evals_fauB = PCETsample(sys_fauB,'basis',n_samples);

fprintf('\nEvaluating collocation samples...\n')
col.org  = PCETsample(sys_org, 'basis',col_samples);
col.fauA = PCETsample(sys_fauA,'basis',col_samples);
col.fauB = PCETsample(sys_fauB,'basis',col_samples);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% (2) simulating the scenarios
fprintf('\nSimulating undiscriminated scenarios...\n')
Org_PC  = PCETsimCollocation(sys_org ,'ex5_ODE_org' ,'ex5_OUT_org' ,col.org,simoptions,'method','final');
FauA_PC = PCETsimCollocation(sys_fauA,'ex5_ODE_fauA','ex5_OUT_fauA',col.fauA,simoptions,'method','final');
FauB_PC = PCETsimCollocation(sys_fauB,'ex5_ODE_fauB','ex5_OUT_fauB',col.fauB,simoptions,'method','final');
fprintf('\n')
...
Org_PC  = PCETsimCollocation(sys_org, 'ex5_ODE_org' ,'ex5_OUT_org' ,col.org,simoptions,'uv1',uv1,'uv2',uv2,'method','final');
FauA_PC = PCETsimCollocation(sys_fauA,'ex5_ODE_fauA','ex5_OUT_fauA',col.fauA,simoptions,'uv1',uv1,'uv2',uv2,'method','final');
FauB_PC = PCETsimCollocation(sys_fauB,'ex5_ODE_fauB','ex5_OUT_fauB',col.fauB,simoptions,'uv1',uv1,'uv2',uv2,'method','final');
